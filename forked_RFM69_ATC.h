...
// **********************************************************************************
#ifndef _FORKED_RFM69_ATC_H_
#define _FORKED_RFM69_ATC_H_
#include "forked_RFM69.h"

#define RFM69_CTL_RESERVE1  0x20

class ForkedRFM69_ATC: public ForkedRFM69
{
  public:
    ...
    ForkedRFM69_ATC(uint8_t slaveSelectPin=RF69_SPI_CS, uint8_t interruptPin=RF69_IRQ_PIN, bool isRFM69HW=false, SPIClass *spi=nullptr) :
      ForkedRFM69(slaveSelectPin, interruptPin, isRFM69HW, spi) {
    }
